...
//doubleDistance
//returns the distance of an object infront of robbi
double doubleDistance()
{
	...
	printf("Distance from Distance function:%.2f cm\n",distance);
...
//startInit()
//intializes 18th pin for input and the 16th pin for output
void startInit(){
	if (!bcm2835_init())
		return 1;
